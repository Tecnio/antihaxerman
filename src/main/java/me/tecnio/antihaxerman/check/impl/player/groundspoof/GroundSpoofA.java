...
public final class GroundSpoofA extends Check {
    ...
    public void handle(final Packet packet) {
        if (packet.isPosition()) {
            ...
            final boolean exempt = isExempt(ExemptType.BOAT, ExemptType.LIQUID, ExemptType.CLIMBABLE, ExemptType.VEHICLE, ExemptType.TELEPORT, ExemptType.CHUNK, ExemptType.SLIME);
