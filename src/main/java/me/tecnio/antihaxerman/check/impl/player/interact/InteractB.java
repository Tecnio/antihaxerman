...
public final class InteractB extends Check {
    ...
    public void handle(final Packet packet) {
        if (packet.isBlockPlace()) {
            ...
            final Location blockLocation = new Location(data.getPlayer().getWorld(), wrapper.getBlockPosition().getX(), wrapper.getBlockPosition().getY(), wrapper.getBlockPosition().getZ());
