...
public enum ExemptType {
    ...
    SLOW(data -> !data.getPositionTracker().isLastPosition()
            || !data.getPositionTracker().isLastLastPosition()),
    ...
    WEB(data -> data.getPositionTracker().isWeb()
            || data.getPositionTracker().isLastWeb()),

    CLIMBABLE(data -> data.getPositionTracker().isClimbable()
            || data.getPositionTracker().isLastClimbable()),

    UNDER_BLOCK(data -> data.getPositionTracker().isUnderBlock()
            || data.getPositionTracker().isLastUnderBlock()),

    PISTON(data -> data.getPositionTracker().isPiston()
            || data.getPositionTracker().isLastPiston()),

    BOAT(data -> data.getPositionTracker().isBoat()),

    SLIME(data -> data.getPositionTracker().isSlime()
            || data.getPositionTracker().isLastSlime()),

    SOUL_SAND(data -> data.getPositionTracker().isSoulSand()
            || data.getPositionTracker().isLastSoulSand()),

    ICE(data -> data.getPositionTracker().isIce()
            || data.getPositionTracker().isLastIce()),

    WALL(data -> data.getPositionTracker().isWall()
            || data.getPositionTracker().isLastWall()),

    STEP(data -> data.getPositionTracker().isFucked()
            || data.getPositionTracker().isLastFucked()),
    ...
    FLIGHT(data -> data.getPlayer().getAllowFlight()
            || data.getPlayer().isFlying()),

    SNEAK_EDGE(data -> data.getActionTracker().isSneaking()
            && data.getPositionTracker().isLastOnGround()
            && data.getPositionTracker().isAirBelow()),
